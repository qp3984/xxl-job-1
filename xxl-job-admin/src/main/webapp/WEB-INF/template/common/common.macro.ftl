	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "jobdatasource">active</#if>" ><a href="${request.contextPath}/jobdatasource"><i class="fa fa-circle-o text-purple"></i><span>数据源管理</span></a></li>
                <li class="nav-click <#if pageName == "jobsql">active</#if>" ><a href="${request.contextPath}/jobsql"><i class="fa fa-circle-o text-fuchsia"></i><span>SQL执行器</span></a></li>
